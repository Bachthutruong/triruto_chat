...
const TrainingDataSchema = new mongoose_1.Schema({
...
const TrainingDataModel = mongoose_1.models.TrainingData || mongoose_1.default.model('TrainingData', TrainingDataSchema);
exports.default = TrainingDataModel;
