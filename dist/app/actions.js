...
exports.getAllCustomerMessages = getAllCustomerMessages;
...
exports.updateCustomerAppointmentStatus = updateCustomerAppointmentStatus;
exports.getCurrentCustomerProfile = getCurrentCustomerProfile;
...
exports.getStaffMediaMessages = getStaffMediaMessages;
...
const socket_emitter_1 = require("../lib/utils/socket-emitter");
...
function transformAppSettingsDoc(doc) {
    ...
    return {
        ...
        breakTimeNotificationEnabled: (_c = doc.breakTimeNotificationEnabled) !== null && _c !== void 0 ? _c : initialDefaultSettings.breakTimeNotificationEnabled,
        ...
        outOfOfficeResponseEnabled: (_d = doc.outOfOfficeResponseEnabled) !== null && _d !== void 0 ? _d : initialDefaultSettings.outOfOfficeResponseEnabled,
...
function getCurrentBreakTime(appSettings) {
    var _a;
    try {
        if (!appSettings.breakTimeNotificationEnabled || !appSettings.breakTimes || appSettings.breakTimes.length === 0) {
            console.log("[DEBUG getCurrentBreakTime] Early return:", {
                ...
                breakTimesLength: ((_a = appSettings.breakTimes) === null || _a === void 0 ? void 0 : _a.length) || 0
            });
            return null;
        }
        const now = new Date();
...
async function handleCustomerAccess(phoneNumber) {
    ...
    if (!customer) {
        ...
        (0, socket_emitter_1.emitNewCustomerNotification)({
    ...
    if (activeConversation.messageIds && activeConversation.messageIds.length > 0) {
        ...
        if (typeof firstMessageId === 'object' && firstMessageId !== null && '_id' in firstMessageId) {
            ...
            const conversationMessageDocs = await Message_model_1.default.find({ _id: { $in: activeConversation.messageIds } }).sort({ timestamp: 1 });
...
async function getAllCustomerMessages(customerId, messageLimit) {
    await (0, mongodb_1.default)();
    ...
    const customer = await Customer_model_1.default.findById(customerId).populate({
    ...
    for (const convDoc of customer.conversationIds) {
        if (convDoc && convDoc.messageIds && convDoc.messageIds.length > 0) {
            const conversationMessages = convDoc.messageIds
    ...
    try {
        ...
        try {
            ...
            if ((0, date_fns_1.isValid)(dateObj)) {
                const formattedDate = (0, date_fns_1.format)(dateObj, 'dd/MM/yyyy', { locale: locale_1.vi });
...
async function processUserMessage(userMessageContent, currentUserSession, currentConversationId, currentChatHistory) {
    ...
    if (cloudinaryMatch) {
        ...
        textForAI = ((_a = cloudinaryMatch[3]) === null || _a === void 0 ? void 0 : _a.trim()) || `Tôi đã gửi một tệp: ${originalFileName}. Bạn có thể phân tích hoặc mô tả nó không?`;
        ...
        if (dataUriMatch) {
            try {
                ...
                const uploadResult = await (0, cloudinary_1.uploadToCloudinary)(fileDataUri, originalFileName, 'triruto_chat/messages');
                ...
                textForAI = (textContent === null || textContent === void 0 ? void 0 : textContent.trim()) || `Tôi đã gửi một tệp: ${originalFileName}. Bạn có thể phân tích hoặc mô tả nó không?`;
                ...
                textForAI = ((_b = dataUriMatch[3]) === null || _b === void 0 ? void 0 : _b.trim()) || `Tôi đã gửi một tệp: ${originalFileName}. Bạn có thể phân tích hoặc mô tả nó không?`;
    ...
    if (customer) {
        (0, socket_emitter_1.emitNewMessageNotification)({
    ...
    try {
        console.log("[DEBUG] App settings for break time check:", {
            breakTimeNotificationEnabled: appSettings.breakTimeNotificationEnabled,
            breakTimesCount: ((_c = appSettings.breakTimes) === null || _c === void 0 ? void 0 : _c.length) || 0,
    ...
    if (currentBreakTime) {
        ...
        if (!scheduleOutputFromAI) {
            ...
            if ((scheduleOutputFromAI.intent === 'booked' || scheduleOutputFromAI.intent === 'rescheduled') &&
                ((_d = scheduleOutputFromAI.appointmentDetails) === null || _d === void 0 ? void 0 : _d.date) && ((_e = scheduleOutputFromAI.appointmentDetails) === null || _e === void 0 ? void 0 : _e.time) &&
                ...
                const targetBranchId = (_f = activeBranches.find(b => { var _a; return b.name === ((_a = scheduleOutputFromAI === null || scheduleOutputFromAI === void 0 ? void 0 : scheduleOutputFromAI.appointmentDetails) === null || _a === void 0 ? void 0 : _a.branch); })) === null || _f === void 0 ? void 0 : _f.id;
                ...
                if (!productForService || !productForService.isSchedulable) {
                    ...
                    const effectiveSchedulingRules = {
                        numberOfStaff: (_j = (_h = (_g = productForService.schedulingRules) === null || _g === void 0 ? void 0 : _g.numberOfStaff) !== null && _h !== void 0 ? _h : appSettings.numberOfStaff) !== null && _j !== void 0 ? _j : 1,
                        workingHours: ((_l = (_k = productForService.schedulingRules) === null || _k === void 0 ? void 0 : _k.workingHours) === null || _l === void 0 ? void 0 : _l.length) ? productForService.schedulingRules.workingHours : (_m = appSettings.workingHours) !== null && _m !== void 0 ? _m : [],
                        weeklyOffDays: ((_p = (_o = productForService.schedulingRules) === null || _o === void 0 ? void 0 : _o.weeklyOffDays) === null || _p === void 0 ? void 0 : _p.length) ? productForService.schedulingRules.weeklyOffDays : (_q = appSettings.weeklyOffDays) !== null && _q !== void 0 ? _q : [],
                        oneTimeOffDates: ((_s = (_r = productForService.schedulingRules) === null || _r === void 0 ? void 0 : _r.oneTimeOffDates) === null || _s === void 0 ? void 0 : _s.length) ? productForService.schedulingRules.oneTimeOffDates : (_t = appSettings.oneTimeOffDates) !== null && _t !== void 0 ? _t : [],
                        specificDayRules: ((_v = (_u = productForService.schedulingRules) === null || _u === void 0 ? void 0 : _u.specificDayRules) === null || _v === void 0 ? void 0 : _v.length) ? productForService.schedulingRules.specificDayRules : (_w = appSettings.specificDayRules) !== null && _w !== void 0 ? _w : [],
                    };
                    const serviceDuration = (_z = (_y = (_x = productForService.schedulingRules) === null || _x === void 0 ? void 0 : _x.serviceDurationMinutes) !== null && _y !== void 0 ? _y : appSettings.defaultServiceDurationMinutes) !== null && _z !== void 0 ? _z : 60;
    ...
    if (customer) {
        (0, socket_emitter_1.emitChatReplyNotification)({
            customerId: customerId,
            customerName: customer.name,
...
async function updateCustomerAppointmentStatus(customerId, isAppointmentDisabled) {
    var _a, _b, _c;
    await (0, mongodb_1.default)();
    const customer = await Customer_model_1.default.findByIdAndUpdate(customerId, { isAppointmentDisabled, lastInteractionAt: new Date() }, { new: true }).populate('assignedStaffId', 'name');
    if (!customer)
        throw new Error("Không tìm thấy khách hàng.");
    return {
        id: customer._id.toString(),
...
async function getCurrentCustomerProfile(customerId) {
    var _a, _b, _c;
    await (0, mongodb_1.default)();
    const customer = await Customer_model_1.default.findById(customerId)
        .populate('assignedStaffId', 'name');
...
async function addNoteToCustomer(customerId, staffId, content, imageDataUri, imageFileName) {
    ...
    try {
        ...
        if (imageDataUri && imageFileName) {
            const uploadResult = await (0, cloudinary_1.uploadToCloudinary)(imageDataUri, imageFileName, 'triruto_chat/notes');
...
async function updateCustomerNote(noteId, staffId, content, imageDataUri, imageFileName) {
    ...
    if (imageDataUri === null) {
        ...
        if (note.imagePublicId) {
            await (0, cloudinary_1.deleteFromCloudinary)(note.imagePublicId);
        }
    ...
    if (allMediaMessages.length > 0) {
        console.log('[DEBUG] Sample media messages:', allMediaMessages.slice(0, 3).map(m => {
            ...
            return ({
                id: m._id.toString(),
                sender: m.sender,
                staffId: ((_a = m.staffId) === null || _a === void 0 ? void 0 : _a.toString()) || 'null',
