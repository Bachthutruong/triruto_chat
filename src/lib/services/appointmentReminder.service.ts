...
export class AppointmentReminderService {
     ...
     */
    static async scheduleReminder(appointmentId: string | Types.ObjectId) {
     ...
     */
    static async cancelReminder(appointmentId: string | Types.ObjectId) {
        await AppointmentReminderModel.updateMany(
            { appointmentId, status: 'pending' },
            { status: 'failed', errorMessage: 'Appointment cancelled' }
        );
    }
} 