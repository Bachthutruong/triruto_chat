...
import type { Conversation, UserRole } from '@/lib/types'; // Assuming UserRole is in lib/types
...
const ConversationSchema: Schema<IConversation> = new Schema({
  ...
  title: { type: String },
  participants: [ParticipantSchema], // Array of participants (customer, staff, admin)
  messageIds: [{ type: Schema.Types.ObjectId, ref: 'Message' }],
  pinnedMessageIds: [{ type: Schema.Types.ObjectId, ref: 'Message' }],
  isPinned: { type: Boolean, default: false }, // For user-specific pinning, managed on CustomerProfile
